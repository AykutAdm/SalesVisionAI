...
namespace SalesVisionAI.WebUI.ViewComponents.CustomerReviewViewComponents
{
    public class _CustomerReviewWithOpenAIAnalysisComponentPartial : ViewComponent
    {
        ...
        public _CustomerReviewWithOpenAIAnalysisComponentPartial(SalesVisionAIDbContext context, IHttpClientFactory httpClientFactory)
        {
            _context = context;
