...
using SalesVisionAI.WebUI.Dtos.LoyaltyDtos;
using SalesVisionAI.WebUI.Dtos.LoyaltyMLDtos;
...
namespace SalesVisionAI.WebUI.Controllers
{
    public class CustomerLoyaltyController : Controller
    {
        ...
        public CustomerLoyaltyController(SalesVisionAIDbContext context)
        {
            _context = context;
        }
            ...
            var loyaltScores = _context.Customers
                ...
                .Select(x =>
                {
                    var daySinceLastOrder = (x.LastOrderDate.HasValue)
                        ? (today - x.LastOrderDate.Value).TotalDays
                        : double.MaxValue;
        ...
        public IActionResult ItalyLoyaltyScoreWithML()
        {
            ...
            var data = _context.Customers
              ...
              .Select(c =>
              {
                  ...
                  var daySince = lastOrderDate.HasValue ? Math.Round((today - lastOrderDate.Value).TotalDays) : 999;
